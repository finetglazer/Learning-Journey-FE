...
type props = {
  ...
  buttonIconCenter?: JSX.Element;
  disableButtonCenter?: boolean;
  textButtonCenter: string;
  onHandleClickAddCenter?: () => void;
};
      ...
      <div className="empty-data-table__body__content">
        ...
        <div className="d-flex">
          ...
          <div
            className={classNames(
              "empty-data-table__body__content__button m-r--2xs",
              disableButtonCenter ? "disable_button_icon" : ""
            )}
          >
            <Button
              icon={
              ...
              iconPlace="left"
              type="tertiary"
              onClick={onHandleClickAddCenter}
              // disabled={disableButtonCenter}
            >
              {textButtonCenter}
            </Button>
          </div>
