...
import { ContractRequestType, ModelSelect } from "models/Settlement";
...
interface PurchaseRequestConfirmModalProps {
  ...
  model?: Settlement | any;
  isLoading: boolean;
  loadingButton: boolean;
  errorMessage?: string;
  onApply?: (model: Settlement | any, reason?: string) => void;
  onCancel?: () => void;
...
const ModalActionConfirm = ({
    ...
    (type: ConfirmModalType): ModalProps => {
      const modalProps = {
        [ConfirmModalType.DELETE]: {
          title: translate("settlement.title_confirm_delete", {
        ...
        [ConfirmModalType.CANCEL]: {
          title: translate("settlement.title_confirm_cancel", {
            typeContract: isContract
              ? translate("settlement.title_contract")
              : translate("settlement.content_purchase_order"),
          }),
        ...
        [ConfirmModalType.RETURN]: {
          title: translate("settlement.title_confirm_return", {
            typeContract: isContract
              ? translate("settlement.title_contract")
              : translate("settlement.content_purchase_order"),
          }),
        ...
        [ConfirmModalType.REJECT]: {
          title: translate("settlement.title_confirm_reject", {
            typeContract: isContract
              ? translate("settlement.title_contract")
              : translate("settlement.content_purchase_order"),
          }),
  ...
  return (
    <ModalConfirm
      ...
      content={
        <Trans
          i18nKey={`settlement.${modalProps?.content[0]}`}
          values={{
