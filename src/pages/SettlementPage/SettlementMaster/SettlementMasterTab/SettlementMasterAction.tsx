...
import SettlementMasterTabAdvanceFilter from "./SettlementMasterTabAdvanceFilter";
import { authorizationService } from "core/services/common-services/authorization-service";

const SettlementMasterAction = () => {
      ...
      <div className="page-master__actions d-flex justify-content-between align-items-center gap-12">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("settlement.plh_search")}
            onChange={run}
            type={1}
            isSmall
          />
        ...
        <Dropdown
          dropdownRender={() => (
            <SettlementMasterTabAdvanceFilter
              setVisible={() => {
                buttonRef.current.click();
              }}
            />
...
export default SettlementMasterAction;
