...
import { VIETNAMESE_CURRENCY } from "pages/PurchasePage/PurchasingPlanPage/PurchasingPlanDetail/SelectSupplierTab/Components/SelectSupplierSection/SelectSupplierSection";
...
const TableGoodsService = ({ quotation }: TableGoodsServiceProps) => {
  ...
  const isVNDCurrency = useMemo(
    () => isEqual(currencyCode, VIETNAMESE_CURRENCY || JPY_CURRENCY_UNIT),
    [currencyCode]
  );
        ...
        render: (_, record) => {
          if (record?.isTotal) {
            const totalAmount = round(
              ...
              isVNDCurrency ? numberConstants.ZERO : TWO_NUMBER_FIX
            );
            return (
              <LayoutCell position="right">
                <OneLineText
        ...
        render: (_, record) => {
          if (record?.isTotal) {
            const totalTax = round(
              ...
              isVNDCurrency ? numberConstants.ZERO : FOUR_NUMBER_FIX
            );
            return (
              <LayoutCell position="right">
                <OneLineText
