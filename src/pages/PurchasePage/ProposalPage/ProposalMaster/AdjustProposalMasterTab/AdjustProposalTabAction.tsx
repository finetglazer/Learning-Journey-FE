...
import AdjustProposalMasterTabAdvanceFilter from "./AdjustProposalMasterTabAdvanceFilter";
import { authorizationService } from "core/services/common-services/authorization-service";

const AdjustProposalTabAction = () => {
  ...
  const { validAction: validActionAdjustment } =
    authorizationService.useAuthorizedAction("PURCHASE_PROPOSAL", "Adjustment");
    ...
    <>
      <>
        ...
        <div className="page-master__actions d-flex align-items-center justify-content-end gap-x--xs">
          ...
          <Dropdown
            dropdownRender={() => (
              <AdjustProposalMasterTabAdvanceFilter
...
export default AdjustProposalTabAction;
