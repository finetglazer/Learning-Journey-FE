...
import MasterAdvanceFilter from "./ProposalMasterTabAdvanceFilter";
      ...
      <div className="page-master__actions d-flex align-items-center justify-content-end  gap-x--xs">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("PP.plh_search")}
            onChange={run}
            type={1}
            isSmall
          />
...
export default ProposalMasterAction;
