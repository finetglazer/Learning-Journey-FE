...
import { PURCHASING_PLAN_BIDDING_VIEW_ROUTE } from "config/route-const";
...
const ModalSelectSupplier = ({ open, handleCancel, onPressSave }: Props) => {
  ...
  const handleSaveModal = () => {
    ...
    history.push({
      pathname: `${PURCHASING_PLAN_BIDDING_VIEW_ROUTE}/${modelMaster?.idDetail}`,
      search: `?tabKey=${TabKeyBidder.ReviewSummary}`,
    });
  };
