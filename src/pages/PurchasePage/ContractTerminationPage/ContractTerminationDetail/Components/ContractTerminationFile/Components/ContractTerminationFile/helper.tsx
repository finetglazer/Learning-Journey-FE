...
import {
  ContractTerminationFile,
  RequestAttachment,
} from "./ContractTerminationFile";
...
}: helperColumnsProps): ColumnProps<ContractTerminationFile>[] => [
  {
    title: () => (
    ...
    render: (_, record, index) => (
      ...
      >
        <div className="px-2 d-flex justify-content-between w-100">
          ...
          <Button className="btn d-flex align-items-center settlement-file_ct-h-44">
            <UploadFileCustom
...
export const handleChangeItemTable = (
  ...
  const contractFiles = model?.contractFiles.map(
    (item: ContractTerminationFile) => {
      if (id === item?.id) {
        return {
          ...item,
          [fieldName]: value,
...
export const ViewFilesColumns = ({
  translate,
  handleDownloadFileAttached,
}: ViewFilesColumnsProps): ColumnProps<ContractTerminationFile>[] => [
  {
    title: translate("contractTermination.upload_time"),
    width: 180,
  ...
  {
    title: translate("contractTermination.file_description"),
    key: ColumnKey.NOTE,
    dataIndex: ColumnKey.NOTE,
    render(value) {
      return (
  ...
  {
    title: translate("contractTermination.attachment"),
    key: ColumnKey.ATTACHMENTS,
    dataIndex: ColumnKey.ATTACHMENTS,
    render(value) {
      return (
        <LayoutCell className="row">
