...
import { ContractMasterAdvancedFilter } from "../../Components/ContractAdjustmentAdvancedFilter/ContractAdjustmentAdvancedFilter";
...
const ContractAdjustmentTabAction = () => {
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate(
              "contractAdjustment.list.placeholder.quickly_search"
            )}
...
export default ContractAdjustmentTabAction;
