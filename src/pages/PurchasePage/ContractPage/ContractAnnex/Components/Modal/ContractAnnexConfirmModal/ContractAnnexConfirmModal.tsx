...
interface ContractAnnexConfirmModalProps {
  type: ConfirmModalType;
  model?: ContractAnnex;
  isLoading: boolean;
  onApply?: (contractAnnexId: string, reason: string) => void;
  onCancel?: () => void;
  errorMessage?: string;
}

export const ContractAnnexConfirmModal = ({
  type,
  model,
  isLoading,
  onApply,
  onCancel,
  errorMessage,
}: ContractAnnexConfirmModalProps) => {
  ...
  return (
    <ModalConfirm
      ...
      content={
        <Trans
          i18nKey={`CA.${modalProps?.content[numberConstants.ZERO]}`}
          values={{
