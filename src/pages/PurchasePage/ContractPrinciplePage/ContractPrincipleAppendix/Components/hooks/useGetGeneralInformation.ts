...
import { annexTypeList } from "pages/PurchasePage/ContractPrinciplePage/constants";
...
export const useGetGeneralInformation = ({
          ...
          const newData: ContractAnnex = {
            ...
            contractInfo: {
              ...
              applicableOrganization: {
                id: contractInfo?.applicableOrganizationId,
                name: contractInfo?.applicableOrganizationName,
              },
              applicableBranch: {
                id: contractInfo?.applicableBranchId,
                name: contractInfo?.applicableBranchName,
              },
              applicableUnit: {
                id: contractInfo?.applicableUnitId,
                name: contractInfo?.applicableUnitName,
              },
            },
            ...
            adjustmentTypeValue: annexTypeList.find(
              (item) => item.id === response?.adjustmentType
            ),
  ...
  const getContractAnnexDetail = useCallback(() => {
    ...
    setLoading(true);
    contractAnnexRepository.getContractAnnexDetail(id, isView, true).subscribe({
