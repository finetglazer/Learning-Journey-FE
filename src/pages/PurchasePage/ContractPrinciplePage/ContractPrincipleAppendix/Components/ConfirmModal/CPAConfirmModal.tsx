...
interface CPAConfirmModalProps {
...
export const CPAConfirmModal = ({
  ...
  return (
    <ModalConfirm
      ...
      content={
        <Trans
          i18nKey={`CPA.${modalProps?.content[numberConstants.ZERO]}`}
          values={{
