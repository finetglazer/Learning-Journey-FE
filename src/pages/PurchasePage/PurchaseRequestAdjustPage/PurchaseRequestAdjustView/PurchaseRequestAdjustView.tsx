...
import GroupAction from "pages/PurchasePage/PurchaseRequestPage/PurchaseRequestView/Components/GroupAction/GroupAction";
...
const PurchaseRequestAdjustView = () => {
...
export default PurchaseRequestAdjustView;
