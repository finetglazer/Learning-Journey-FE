...
interface ConfirmModalProps {
  ...
  model?: Goods;
  isLoading: boolean;
  onApply?: (id: string, reason: string) => void;
  onCancel?: () => void;
  errorMessage?: string;
}
...
export const ConfirmModal = ({
  ...
  return (
    <ModalConfirm
      ...
      content={
        <Trans
          i18nKey={`PS.${modalProps?.content[numberConstants.ZERO]}`}
          values={{
