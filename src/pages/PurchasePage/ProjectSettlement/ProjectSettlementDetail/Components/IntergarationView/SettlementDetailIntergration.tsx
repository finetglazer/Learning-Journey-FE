...
import styles from "./SettlementDetailIntergration.module.scss";
import AdvancedCollapseView from "components/AdvancedCollapseView/AdvancedCollapseView";
import { Model } from "react-3layer-common";
import appMessageService from "core/services/common-services/app-message-service";
import { AxiosError } from "axios";

import { useProjectSettlementDetailHook } from "../../ProjectSettlementDetailHook";
...
const SettlementDetailIntergration = () => {
  ...
  const { model, handleChangeAllField } = useProjectSettlementDetailHook();
...
export default SettlementDetailIntergration;
