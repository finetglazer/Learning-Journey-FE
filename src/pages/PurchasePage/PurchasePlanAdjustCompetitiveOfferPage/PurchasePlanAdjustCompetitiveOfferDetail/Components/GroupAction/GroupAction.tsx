...
import { PurchasePlanAdjustCompetitiveOfferDetailHookContext } from "../../PurchasePlanAdjustCompetitiveOfferDetailHook";
import {
  ConfirmModalType,
  PurchasingPlanCompetitiveOfferSendApproveModal,
} from "../PurchasingPlanCompetitiveOfferSendApproveModal";

const GroupAction = () => {
  const contextValue = useContext(
    PurchasePlanAdjustCompetitiveOfferDetailHookContext
  );
  const { model, handleValidateSaveForm, handleSave, setModelSelected } =
    contextValue;
