...
import { TemporaryImportAssetViewHookContext } from "pages/PurchasePage/TemporaryImportAssetPage/TemporaryImportAssetView/TemporaryImportAssetViewHook";

type Props = {
  files: RequestAttachment[];
};
const AttachedFileView = ({ files }: Props) => {
  const { handleDownloadFileAttached } =
