...
import { CODE_TYPE_EXPENSE_DCNCC } from "models/Payment/PaymentRequestConstant";
...
const ExpenseReversalGeneralInfoTab = () => {
          ...
          <div className="">
            ...
            <div className="m-t--lg">
              ...
              {model?.paymentDetailInfomation?.paymentRequestType?.code ===
                CODE_TYPE_EXPENSE_DCNCC && <SupplierInfo />}
            </div>
          </div>
        </div>
...
export default ExpenseReversalGeneralInfoTab;
