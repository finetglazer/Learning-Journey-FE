...
import { CODE_TYPE_DEPOSIT } from "models/Payment/PaymentRequestConstant";
          ...
          <div className="">
            ...
            <div className="m-t--lg">
              ...
              {model?.paymentDetailInfomation?.paymentRequestType?.code ===
                CODE_TYPE_DEPOSIT && <SupplierInfo />}
            </div>
            <div className="m-t--lg">
...
export default DepositGeneralInfoTab;
