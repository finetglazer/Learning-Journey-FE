...
import { SupplierEvaluationConfigMasterAdvanceFilter } from "./SupplierEvaluationConfigMasterAdvanceFilter";

export const SupplierEvaluationConfigMasterAction = () => {
  const supplierEvaluationConfigs =
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <SupplierEvaluationConfigMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("supplierEvaluationConfigs.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
