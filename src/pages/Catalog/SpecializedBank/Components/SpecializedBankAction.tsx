...
import { SpecializedBankAdvanceFilter } from "./SpecializedBankAdvanceFilter";

const ICON_SIZE = 16;

export const SpecializedBankAction = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
      ...
      <div className="page-master__actions d-flex align-items-center gap-12 w-full justify-content-flex-end">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("SB.placeholder_quickly_search")}
            onChange={run}
