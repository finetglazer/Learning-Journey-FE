...
export const TaxModalDelete = () => {
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("taxs.deleteTitle")
          : `${translate("taxs.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("taxs.bulkDeleteTitle2")}`
      }
      content={translate("taxs.deleteContent")}
    />
  );
};
