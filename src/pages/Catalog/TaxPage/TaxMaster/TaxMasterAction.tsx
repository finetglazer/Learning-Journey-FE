...
import { TaxMasterContextModel, TaxMasterContext } from "./TaxMasterHook";
import { TaxMasterAdvanceFilter } from "./TaxAdvanceFilter";

export const TaxMasterAction = () => {
  const tax = useContext<TaxMasterContextModel>(TaxMasterContext);
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
