...
import { TaxEmptySearchData } from "./TaxEmptySearchData";
...
export const TaxMasterTable = () => {
  ...
  const columns: ColumnProps<Tax>[] = useMemo(
    () => [
      {
        title: translate("taxs.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, Tax, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("taxs.rate"),
        key: "rate",
        dataIndex: "rate",
        sorter: true,
        render(...params: [number, Tax, number]) {
          return (
            <LayoutCell>
              <OneLineText value={formatNumber(params[0] || 0)} useTooltip />
            </LayoutCell>
          );
        },
      },
      ...
      {
        title: translate("taxs.description"),
        key: "description",
