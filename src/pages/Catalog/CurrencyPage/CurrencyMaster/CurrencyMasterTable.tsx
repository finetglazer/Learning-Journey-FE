...
import "./CurrencyMaster.scss";

import {
  CurrencyMasterContext,
  CurrencyMasterContextModel,
} from "./CurrencyMasterHook";
import { CurrencyEmptySearchData } from "./CurrencyEmptySearchData";
...
export const CurrencyMasterTable = () => {
  ...
  const columns: ColumnProps<Currency>[] = useMemo(
    () => [
      {
        title: translate("currencies.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, Currency, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("currencies.name"),
        key: "name",
        dataIndex: "name",
        sorter: true,
        render(...params: [string, Currency, number]) {
      ...
      {
        title: translate("currencies.status"),
        key: "isActive",
        dataIndex: "isActive",
        sorter: true,
        width: "200px",
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: Currency) {
          return (
