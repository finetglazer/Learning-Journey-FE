...
import { CurrencyMasterAdvanceFilter } from "./CurrencyAdvanceFilter";

export const CurrencyMasterAction = () => {
  const currency = useContext<CurrencyMasterContextModel>(
    CurrencyMasterContext
  );
  const {
    modelFilter,
