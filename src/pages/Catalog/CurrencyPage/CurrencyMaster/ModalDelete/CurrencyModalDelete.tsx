...
export const CurrencyModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("currencies.deleteTitle")
          : `${translate("currencies.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("currencies.bulkDeleteTitle2")}`
      }
      content={translate("currencies.deleteContent")}
    />
  );
};
