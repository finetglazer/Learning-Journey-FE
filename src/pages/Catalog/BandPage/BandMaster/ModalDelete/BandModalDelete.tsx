...
export const BandModalDelete = () => {
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("bands.deleteTitle")
          : `${translate("bands.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("bands.bulkDeleteTitle2")}`
      }
      content={translate("bands.deleteContent")}
    />
  );
};
