...
import { BandMasterContextModel, BandMasterContext } from "./BandMasterHook";
import { BandMasterAdvanceFilter } from "./BandAdvanceFilter";

export const BandMasterAction = () => {
  const band = useContext<BandMasterContextModel>(BandMasterContext);
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
