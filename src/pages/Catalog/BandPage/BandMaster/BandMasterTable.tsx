...
import "./BandMaster.scss";

import { BandMasterContext, BandMasterContextModel } from "./BandMasterHook";
import { BandEmptySearchData } from "./BandEmptySearchData";
...
export const BandMasterTable = () => {
  ...
  const columns: ColumnProps<Band>[] = useMemo(
    () => [
      {
        title: translate("bands.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, Band, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("bands.effectiveDate"),
        key: "effectiveDate",
        dataIndex: "effectiveDate",
        sorter: true,
        render(...params: [Dayjs, Band, number]) {
          return (
            <LayoutCell>
              <OneLineText
                value={
