...
import { PaymentConditionAdvancedFilter } from "./PaymentConditionAdvancedFilter";
...
export const PaymentConditionAction = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
      ...
      <div className="page-master__actions d-flex align-items-center gap-12 w-full justify-content-flex-end">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("PC.placeholder_quickly_search")}
            onChange={run}
        ...
        <Dropdown
          dropdownRender={() => (
            <PaymentConditionAdvancedFilter
