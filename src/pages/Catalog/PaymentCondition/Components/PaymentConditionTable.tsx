...
export const PaymentConditionTable = () => {
  const {
    loadingList,
    list,
    count,
  ...
  const columns: ColumnProps<PaymentCondition>[] = useMemo(
    () => [
      {
        title: translate("PC.txt_payment_condition_code"),
        key: ColumnKey.CODE,
        dataIndex: ColumnKey.CODE,
        sorter: true,
        sortOrder: getAntOrderType<PaymentCondition, PaymentConditionFilter>(
          modelFilter,
          "code"
        ),
        ellipsis: true,
      ...
      {
        title: translate("PC.txt_payment_condition_name"),
        key: ColumnKey.NAME,
      ...
      {
        title: translate("PC.txt_payment_condition_description"),
