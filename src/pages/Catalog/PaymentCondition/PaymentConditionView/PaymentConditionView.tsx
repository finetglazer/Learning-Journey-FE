...
import { usePaymentConditionViewHook } from "./PaymentConditionViewHook";

import CopySvg from "assets/icons/CostLine/ic_copy.svg";
import styles from "./PaymentConditionView.module.scss";

const MODAL_WIDTH = 600;

export interface PaymentConditionViewProps {
  paymentConditionId: string;
  dismiss: () => void;
}

const PaymentConditionView = ({
  paymentConditionId,
  dismiss,
}: PaymentConditionViewProps) => {
  const { translate, model, isLoading, copyToClipboard } =
    usePaymentConditionViewHook(paymentConditionId);
  ...
  return (
    <Modal
      ...
      title={translate("PC.txt_view_detail_payment_condition")}
      ...
      <div className={styles["wrapper"]}>
        ...
        <div className={styles["description-section"]}>
          <span className={styles["description-label"]}>
            {translate("PC.txt_payment_condition_description")}
          </span>
...
export default PaymentConditionView;
