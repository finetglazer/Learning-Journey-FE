...
import { UnitOfMeasureGroupMasterAdvanceFilter } from "./UnitOfMeasureGroupAdvanceFilter";

export const UnitOfMeasureGroupMasterAction = () => {
  const unitOfMeasureGroup = useContext<UnitOfMeasureGroupMasterContextModel>(
    UnitOfMeasureGroupMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <UnitOfMeasureGroupMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("unitOfMeasureGroups.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
