...
import "./UnitOfMeasureGroupMaster.scss";

import {
  UnitOfMeasureGroupMasterContext,
  UnitOfMeasureGroupMasterContextModel,
} from "./UnitOfMeasureGroupMasterHook";
import { UnitOfMeasureGroupEmptySearchData } from "./UnitOfMeasureEmptySearchData";
...
export const UnitOfMeasureGroupMasterTable = () => {
  ...
  const columns: ColumnProps<UnitOfMeasureGroup>[] = useMemo(
    () => [
      {
        title: translate("unitOfMeasureGroups.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, UnitOfMeasureGroup, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("unitOfMeasureGroups.name"),
        key: "name",
        dataIndex: "name",
        sorter: true,
        render(...params: [string, UnitOfMeasureGroup, number]) {
      ...
      {
        title: translate("unitOfMeasureGroups.unitOfMeasure"),
      ...
      {
        title: translate("unitOfMeasureGroups.status"),
        key: "isActive",
        dataIndex: "isActive",
        sorter: true,
        width: 160,
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: UnitOfMeasureGroup) {
          return (
    ...
    <>
      ...
      <div className="page-master__table">
        <StandardTable
          ...
          locale={{
            emptyText: <UnitOfMeasureGroupEmptySearchData />,
          }}
        />
