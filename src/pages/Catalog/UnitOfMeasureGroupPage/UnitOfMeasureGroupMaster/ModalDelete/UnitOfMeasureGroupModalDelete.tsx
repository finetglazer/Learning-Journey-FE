...
export const UnitOfMeasureGroupModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("unitOfMeasureGroups.deleteTitle")
          : `${translate("unitOfMeasureGroups.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("unitOfMeasureGroups.bulkDeleteTitle2")}`
      }
      content={translate("unitOfMeasureGroups.deleteContent")}
    />
  );
};
