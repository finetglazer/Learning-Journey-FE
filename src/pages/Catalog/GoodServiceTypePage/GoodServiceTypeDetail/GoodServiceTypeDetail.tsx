...
import "./GoodServiceTypeDetail.scss";
import { useGoodServiceTypeDetailHook } from "./GoodServiceTypeDetailHook";
import {
  GoodServiceTypeMasterContext,
  GoodServiceTypeMasterContextModel,
} from "../GoodServiceTypeMaster/GoodServiceTypeMasterHook";

const GoodServiceTypeDetail = () => {
  ...
  return (
    <>
      <Modal
        ...
        title={
          model?.id
            ? `${translate("goodServiceTypes.update")}`
            : `${translate("goodServiceTypes.create")}`
        }
        size={800}
        centered
        ...
        <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} className="p-x--sm">
          ...
          <Col lg={12} className="m-b--xs">
            ...
            >
              <InputText
                isRequired
                maxLength={50}
                label={translate("goodServiceTypes.code")}
                placeHolder={translate("goodServiceTypes.placeholder.code")}
                value={model.code}
          ...
          <Col lg={12} className="m-b--xs">
            ...
            >
              <InputText
                isRequired
                maxLength={500}
                label={translate("goodServiceTypes.name")}
                placeHolder={translate("goodServiceTypes.placeholder.name")}
                value={model.name}
                onChange={handleChangeSingleField({
                  fieldName: "name",
                })}
          ...
          <Col lg={24} className="m-b--xs">
            ...
            >
              <TextArea
                maxLength={255}
                label={translate("goodServiceTypes.description")}
                placeHolder={translate(
                  "goodServiceTypes.placeholder.description"
                )}
...
export default GoodServiceTypeDetail;
