...
interface GoodServiceTypeMasterAdvanceFilterProps {
  setVisible: React.Dispatch<React.SetStateAction<boolean>>;
}

export const GoodServiceTypeMasterAdvanceFilter = ({
  setVisible,
}: GoodServiceTypeMasterAdvanceFilterProps) => {
  ...
  const {
    ...
    ModelFilterClass: GoodServiceTypeFilter,
    filter,
    updateFilter,
