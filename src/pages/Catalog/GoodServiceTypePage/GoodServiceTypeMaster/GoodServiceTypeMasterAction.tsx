...
import { GoodServiceTypeMasterAdvanceFilter } from "./GoodServiceTypeAdvanceFilter";

export const GoodServiceTypeMasterAction = () => {
  const goodServiceType = useContext<GoodServiceTypeMasterContextModel>(
    GoodServiceTypeMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <GoodServiceTypeMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("goodServiceTypes.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
