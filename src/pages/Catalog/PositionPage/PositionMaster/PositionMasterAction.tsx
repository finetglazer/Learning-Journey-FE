...
import { PositionMasterAdvanceFilter } from "./PositionAdvanceFilter";

export const PositionMasterAction = () => {
  const position = useContext<PositionMasterContextModel>(
    PositionMasterContext
  );
  const {
    modelFilter,
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("positions.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
