...
import { PromotionMasterAdvanceFilter } from "./PromotionMasterAdvanceFilter";

export const PromotionMasterAction = () => {
  const promotion = useContext<PromotionMasterContextModel>(
    PromotionMasterContext
  );
  const {
    modelFilter,
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("promotions.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
