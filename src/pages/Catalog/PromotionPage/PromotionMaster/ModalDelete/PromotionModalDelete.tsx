...
export const PromotionModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("promotions.deleteTitle")
          : `${translate("promotions.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("promotions.bulkDeleteTitle2")}`
      }
      content={translate("promotions.deleteContent")}
    />
  );
};
