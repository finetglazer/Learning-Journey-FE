...
import { AreaUnitCodeAdvanceFilter } from "./AreaUnitCodeAdvanceFilter";

const ICON_SIZE = 16;
const DATE_FORMAT = ["MM-YYYY"];

export const AreaUnitCodeActions = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
  ...
  const handleAddNew = () =>
    handleActionAreaUnitCode({
      modal: AreaUnitCodeModal.CREATE,
      id: null,
    });
  ...
  return (
    <div className="area-unit-code__action">
      <div className="area-unit-code__action__left">
        <DatePicker
          isSmall
          picker="month"
      ...
      <div className="area-unit-code__action__right">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("AUC.placeholder_quickly_search")}
            onChange={run}
