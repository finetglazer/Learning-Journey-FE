...
export const BusinessDepartmentModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("businessDepartments.deleteTitle")
          : `${translate("businessDepartments.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("businessDepartments.bulkDeleteTitle2")}`
      }
      content={translate("businessDepartments.deleteContent")}
    />
  );
};
