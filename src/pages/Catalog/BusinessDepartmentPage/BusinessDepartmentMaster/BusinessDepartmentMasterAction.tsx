...
import { BusinessDepartmentMasterAdvanceFilter } from "./BusinessDepartmentMasterAdvanceFilter";

export const BusinessDepartmentMasterAction = () => {
  const businessDepartment = useContext<BusinessDepartmentMasterContextModel>(
    BusinessDepartmentMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <BusinessDepartmentMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("businessDepartments.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
