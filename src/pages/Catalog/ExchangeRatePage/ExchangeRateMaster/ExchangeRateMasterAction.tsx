...
import { ExchangeRateMasterAdvanceFilter } from "./ExchangeRateAdvanceFilter";

export const ExchangeRateMasterAction = () => {
  const exchangeRate = useContext<ExchangeRateMasterContextModel>(
    ExchangeRateMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <ExchangeRateMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("exchangeRates.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
