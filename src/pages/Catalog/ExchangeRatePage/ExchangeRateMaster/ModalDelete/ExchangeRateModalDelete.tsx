...
export const ExchangeRateModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("exchangeRates.deleteTitle")
          : `${translate("exchangeRates.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("exchangeRates.bulkDeleteTitle2")}`
      }
      content={translate("exchangeRates.deleteContent")}
    />
  );
};
