...
import "./SignatureSupplierMaster.scss";

import {
  SignatureSupplierMasterContext,
  SignatureSupplierMasterContextModel,
} from "./SignatureSupplierMasterHook";
import { SignatureSupplierEmptySearchData } from "./SignatureSupplierEmptySearchData";
...
export const SignatureSupplierMasterTable = () => {
  ...
  const columns: ColumnProps<SignatureSupplier>[] = useMemo(
    () => [
      {
        title: translate("signatureSuppliers.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, SignatureSupplier, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("signatureSuppliers.name"),
        key: "name",
        dataIndex: "name",
        sorter: true,
        render(...params: [string, SignatureSupplier, number]) {
      ...
      {
        title: translate("signatureSuppliers.description"),
        key: "description",
      ...
      {
        title: translate("signatureSuppliers.status"),
        key: "isActive",
        dataIndex: "isActive",
        sorter: true,
        width: "200px",
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: SignatureSupplier) {
          return (
    ...
    <>
      ...
      <div className="page-master__table">
        <StandardTable
          ...
          locale={{
            emptyText: <SignatureSupplierEmptySearchData />,
          }}
        />
