...
import { SignatureSupplierMasterAdvanceFilter } from "./SignatureSupplierAdvanceFilter";

export const SignatureSupplierMasterAction = () => {
  const signatureSupplier = useContext<SignatureSupplierMasterContextModel>(
    SignatureSupplierMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <SignatureSupplierMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("signatureSuppliers.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
