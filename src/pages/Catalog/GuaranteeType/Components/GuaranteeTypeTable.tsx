...
export const GuaranteeTypeTable = () => {
  const {
    list,
    count,
    loadingList,
  ...
  const columns: ColumnProps<GuaranteeType>[] = useMemo(
    () => [
      {
        title: translate("GT.txt_guarantee_type_code"),
        key: ColumnKey.CODE,
        dataIndex: ColumnKey.CODE,
        ellipsis: true,
        width: columnsWidth.code,
        sorter: true,
        sortOrder: getAntOrderType<GuaranteeType, GuaranteeTypeFilter>(
          modelFilter,
          "code"
        ),
      ...
      {
        title: translate("GT.txt_guarantee_type_name"),
        key: ColumnKey.NAME,
      ...
      {
        title: translate("GT.txt_guarantee_type_describe"),
