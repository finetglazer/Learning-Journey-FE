...
import { GLAccountMasterAdvanceFilter } from "./GLAccountMasterAdvanceFilter";

export const GLAccountMasterAction = () => {
  const glAccount = useContext<GLAccountMasterContextModel>(
    GLAccountMasterContext
  );
  const {
    modelFilter,
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("glAccounts.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
