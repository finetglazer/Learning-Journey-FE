...
import "./GLAccountMaster.scss";

import {
  GLAccountMasterContext,
  GLAccountMasterContextModel,
} from "./GLAccountMasterHook";
import { GLAccountEmptySearchData } from "./GLAccountEmptySearchData";
...
export const GLAccountMasterTable = () => {
  ...
  const columns: ColumnProps<GLAccount>[] = useMemo(
    () => [
      {
        title: translate("glAccounts.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, GLAccount, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("glAccounts.name"),
        key: "name",
        dataIndex: "name",
        sorter: true,
        render(...params: [string, GLAccount, number]) {
      ...
      {
        title: translate("glAccounts.startDate"),
        key: "startDate",
        dataIndex: "startDate",
        sorter: true,
        render(...params: [Dayjs, GLAccount, number]) {
          return (
            <LayoutCell>
      ...
      {
        title: translate("glAccounts.endDate"),
        key: "endDate",
        dataIndex: "endDate",
        sorter: true,
        render(...params: [Dayjs, GLAccount, number]) {
      ...
      {
        title: translate("glAccounts.status"),
        key: "isActive",
        dataIndex: "isActive",
        sorter: true,
        width: "200px",
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: GLAccount) {
          return (
    ...
    <>
      ...
      <div className="page-master__table">
        <StandardTable
          ...
          locale={{
            emptyText: <GLAccountEmptySearchData />,
          }}
        />
