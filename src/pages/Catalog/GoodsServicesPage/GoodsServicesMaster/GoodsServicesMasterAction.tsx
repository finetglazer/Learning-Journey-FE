...
import { GoodsServicesMasterAdvanceFilter } from "./GoodsServicesMasterAdvanceFilter";

export const GoodsServicesMasterAction = () => {
  const goodsServices = useContext<GoodsServicesMasterContextModel>(
    GoodsServicesMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <GoodsServicesMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("goodsServices.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
