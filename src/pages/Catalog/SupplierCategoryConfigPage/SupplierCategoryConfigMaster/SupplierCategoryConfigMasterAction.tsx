...
import { SupplierCategoryConfigMasterAdvanceFilter } from "./SupplierCategoryConfigAdvanceFilter";

export const SupplierCategoryConfigMasterAction = () => {
  const bank = useContext<SupplierCategoryConfigMasterContextModel>(
    SupplierCategoryConfigMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <SupplierCategoryConfigMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("supplierCategoryConfigs.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
