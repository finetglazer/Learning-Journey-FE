...
import { WarrantyMethodAdvanceFilter } from "./WarrantyMethodAdvanceFilter";

const ICON_SIZE = 16;

export const WarrantyMethodAction = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
      ...
      <div className="page-master__actions d-flex align-items-center gap-12 w-full justify-content-flex-end">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("WM.placeholder_quickly_search")}
            onChange={run}
