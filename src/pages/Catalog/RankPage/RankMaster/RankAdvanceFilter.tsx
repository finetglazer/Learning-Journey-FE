...
import { RankFilter } from "models/Rank";
...
interface RankMasterAdvanceFilterProps {
  setVisible: React.Dispatch<React.SetStateAction<boolean>>;
}

export const RankMasterAdvanceFilter = ({
  setVisible,
}: RankMasterAdvanceFilterProps) => {
        ...
        <Row gutter={16}>
          ...
          <Col lg={24} className="m-b--md">
            <DateRangePicker
              ...
              placeholder={[
                translate("ranks.placeholder.effectiveDateFrom"),
                translate("ranks.placeholder.effectiveDateTo"),
              ]}
              value={[
