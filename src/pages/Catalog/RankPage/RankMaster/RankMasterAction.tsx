...
import { RankMasterContextModel, RankMasterContext } from "./RankMasterHook";
import { RankMasterAdvanceFilter } from "./RankAdvanceFilter";

export const RankMasterAction = () => {
  const rank = useContext<RankMasterContextModel>(RankMasterContext);
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
