...
import "./ContractMethodMaster.scss";

import {
  ContractMethodMasterContext,
  ContractMethodMasterContextModel,
} from "./ContractMethodMasterHook";
import { ContractMethodEmptySearchData } from "./ContractMethodEmptySearchData";
...
export const ContractMethodMasterTable = () => {
  ...
  const columns: ColumnProps<ContractMethod>[] = useMemo(
    () => [
      {
        title: translate("contractMethods.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, ContractMethod, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("contractMethods.name"),
        key: "name",
        dataIndex: "name",
        sorter: true,
        render(...params: [string, ContractMethod, number]) {
      ...
      {
        title: translate("contractMethods.description"),
        key: "description",
      ...
      {
        title: translate("contractMethods.status"),
        key: "isActive",
        dataIndex: "isActive",
        sorter: true,
        width: "200px",
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: ContractMethod) {
          return (
    ...
    <>
      ...
      <div className="page-master__table">
        <StandardTable
          ...
          locale={{
            emptyText: <ContractMethodEmptySearchData />,
          }}
        />
