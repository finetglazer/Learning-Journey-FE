...
import { ContractMethodMasterAdvanceFilter } from "./ContractMethodAdvanceFilter";

export const ContractMethodMasterAction = () => {
  const contractMethod = useContext<ContractMethodMasterContextModel>(
    ContractMethodMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <ContractMethodMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("contractMethods.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
