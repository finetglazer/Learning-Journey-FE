...
import { ManufacturerCategoriesAdvancedFilter } from "./ManufacturerCategoriesAdvancedFilter";
...
export const ManufacturerCategoriesAction = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
      ...
      <div className="page-master__actions d-flex align-items-center gap-12 w-full justify-content-flex-end">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("MC.placeholder_quickly_search")}
            onChange={run}
        ...
        <Dropdown
          dropdownRender={() => (
            <ManufacturerCategoriesAdvancedFilter
