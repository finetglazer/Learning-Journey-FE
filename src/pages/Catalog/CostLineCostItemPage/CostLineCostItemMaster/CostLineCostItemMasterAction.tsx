...
import { CostLineCostItemMasterAdvanceFilter } from "./CostLineCostItemMasterAdvanceFilter";

export const CostLineCostItemMasterAction = () => {
  const costItem = useContext<CostLineCostItemMasterContextModel>(
    CostLineCostItemMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <CostLineCostItemMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
