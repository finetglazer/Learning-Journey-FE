...
import { UnitOfMeasureMasterAdvanceFilter } from "./UnitOfMeasureAdvanceFilter";

export const UnitOfMeasureMasterAction = () => {
  const unitOfMeasure = useContext<UnitOfMeasureMasterContextModel>(
    UnitOfMeasureMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <UnitOfMeasureMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("unitOfMeasures.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
