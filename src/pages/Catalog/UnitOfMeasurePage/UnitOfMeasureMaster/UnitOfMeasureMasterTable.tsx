...
import { UnitOfMeasureEmptySearchData } from "./UnitOfMeasureEmptySearchData";
...
export const UnitOfMeasureMasterTable = () => {
  ...
  const columns: ColumnProps<UnitOfMeasure>[] = useMemo(
    () => [
      ...
      {
        title: translate("unitOfMeasures.isDecimal"),
        key: "isDecimal",
        dataIndex: "isDecimal",
        sorter: true,
        render(...params: [boolean, UnitOfMeasure, number]) {
          return (
            <LayoutCell position="left">
              <Checkbox checked={params[0]} readOnly />
            </LayoutCell>
          );
        },
      },
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: UnitOfMeasure) {
          return (
    ...
    <>
      ...
      <div className="page-master__table">
        <StandardTable
          ...
          locale={{
            emptyText: <UnitOfMeasureEmptySearchData />,
          }}
        />
