...
import { SignatureConfigMasterAdvanceFilter } from "./SignatureConfigAdvanceFilter";

export const SignatureConfigMasterAction = () => {
  const signatureConfig = useContext<SignatureConfigMasterContextModel>(
    SignatureConfigMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <SignatureConfigMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("signatureConfigs.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
