...
export const WarrantyTypeTable = () => {
  const {
    list,
    count,
    loadingList,
  ...
  const columns: ColumnProps<WarrantyType>[] = useMemo(
    () => [
      {
        title: translate("WT.txt_warranty_type_code"),
        key: ColumnKey.CODE,
        dataIndex: ColumnKey.CODE,
        ellipsis: true,
        width: columnsWidth.code,
        sorter: true,
        sortOrder: getAntOrderType<WarrantyType, WarrantyTypeFilter>(
          modelFilter,
          "code"
        ),
      ...
      {
        title: translate("WT.txt_warranty_type_name"),
        key: ColumnKey.NAME,
      ...
      {
        title: translate("WT.txt_warranty_type_describe"),
