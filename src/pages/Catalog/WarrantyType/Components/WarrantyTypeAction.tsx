...
import { WarrantyTypeAdvanceFilter } from "./WarrantyTypeAdvanceFilter";

const ICON_SIZE = 16;

export const WarrantyTypeAction = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
      ...
      <div className="page-master__actions d-flex align-items-center gap-12 w-full justify-content-flex-end">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("WT.placeholder_quickly_search")}
            onChange={run}
