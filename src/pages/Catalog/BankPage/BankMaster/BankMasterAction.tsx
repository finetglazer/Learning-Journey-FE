...
import { BankMasterContextModel, BankMasterContext } from "./BankMasterHook";
import { BankMasterAdvanceFilter } from "./BankAdvanceFilter";

export const BankMasterAction = () => {
  const bank = useContext<BankMasterContextModel>(BankMasterContext);
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
