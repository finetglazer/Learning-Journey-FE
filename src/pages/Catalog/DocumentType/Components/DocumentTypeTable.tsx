...
export const DocumentTypeTable = () => {
  ...
  const columns: ColumnProps<DocumentType>[] = useMemo(
    () => [
      {
        title: translate("DT.txt_document_type_code"),
        key: ColumnKey.CODE,
        dataIndex: ColumnKey.CODE,
        ellipsis: true,
        width: columnsWidth.code,
        sorter: true,
        sortOrder: getAntOrderType<DocumentType, DocumentTypeFilter>(
          modelFilter,
          "code"
        ),
      ...
      {
        title: translate("DT.txt_document_type_name"),
        key: ColumnKey.NAME,
