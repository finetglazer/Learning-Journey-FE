...
import { CommercialTermsAdvanceFilter } from "./CommercialTermsAdvanceFilter";

const ICON_SIZE = 16;

export const CommercialTermsAction = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
  ...
  const handleAddNew = () => setModalType({ type: ConfirmModalType.CREATE });
      ...
      <div className="page-master__actions d-flex align-items-center gap-12 w-full justify-content-flex-end">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("CCT.placeholder_quickly_search")}
            onChange={run}
