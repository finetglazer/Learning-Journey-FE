...
export const CommercialTermsTable = () => {
  const {
    list,
    count,
    loadingList,
  ...
  const columns: ColumnProps<CommercialTerms>[] = useMemo(
    () => [
      {
        title: translate("CCT.txt_commercial_terms_code"),
        key: ColumnKey.CODE,
      ...
      {
        title: translate("CCT.txt_commercial_terms_name"),
        key: ColumnKey.NAME,
      ...
      {
        title: translate("CCT.txt_commercial_terms_describe"),
      ...
      {
        title: translate("CCT.txt_status"),
        ...
        render(_, row: CommercialTerms) {
          const items: ListOverflowMenu[] = [
            ...
            },
            {
              ...
              isShow: isEqual(row?.isUsed, false),
            },
          ];
          return (
            <LayoutCell>
    ...
    [modelFilter, navigateToDetail, setModalType, translate]
  );
