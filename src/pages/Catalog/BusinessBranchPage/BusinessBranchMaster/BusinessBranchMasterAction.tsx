...
import { BusinessBranchMasterAdvanceFilter } from "./BusinessBranchMasterAdvanceFilter";

export const BusinessBranchMasterAction = () => {
  const businessBranch = useContext<BusinessBranchMasterContextModel>(
    BusinessBranchMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <BusinessBranchMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("businessBranchs.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
