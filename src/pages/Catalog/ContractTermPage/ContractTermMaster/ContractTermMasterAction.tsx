...
import { ContractTermMasterAdvanceFilter } from "./ContractTermAdvanceFilter";

export const ContractTermMasterAction = () => {
  const contractTerm = useContext<ContractTermMasterContextModel>(
    ContractTermMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <ContractTermMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("contractTerms.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
