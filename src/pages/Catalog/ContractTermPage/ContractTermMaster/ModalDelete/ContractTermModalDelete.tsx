...
export const ContractTermModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("contractTerms.deleteTitle")
          : `${translate("contractTerms.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("contractTerms.bulkDeleteTitle2")}`
      }
      content={translate("contractTerms.deleteContent")}
    />
  );
};
