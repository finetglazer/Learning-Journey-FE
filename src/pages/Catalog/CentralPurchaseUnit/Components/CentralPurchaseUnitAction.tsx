...
import { CentralPurchaseUnitAdvancedFilter } from "./CentralPurchaseUnitAdvancedFilter";
...
export const CentralPurchaseUnitAction = () => {
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
      ...
      <div className="page-master__actions d-flex align-items-center gap-12 w-full justify-content-flex-end">
        ...
        <div className="w-300px">
          <InputText
            ...
            placeHolder={translate("CPU.placeholder_quickly_search")}
            onChange={run}
        ...
        <Dropdown
          dropdownRender={() => (
            <CentralPurchaseUnitAdvancedFilter
