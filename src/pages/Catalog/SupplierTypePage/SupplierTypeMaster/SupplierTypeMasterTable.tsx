...
import "./SupplierTypeMaster.scss";

import { SupplierTypeEmptySearchData } from "./SupplierTypeEmptySearchData";
import {
...
export const SupplierTypeMasterTable = () => {
  const bankMaster = useContext<SupplierTypeMasterContextModel>(
    SupplierTypeMasterContext
  );
  ...
  const columns: ColumnProps<SupplierType>[] = useMemo(
    () => [
      {
        title: translate("supplierType.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        render(...params: [string, SupplierType, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("supplierType.name"),
        key: "name",
        dataIndex: "name",
        sorter: true,
        render(...params: [string, SupplierType, number]) {
      ...
      {
        title: translate("supplierType.description"),
        key: "description",
      ...
      {
        title: translate("supplierType.status"),
        key: "isActive",
        dataIndex: "isActive",
        sorter: true,
        width: "200px",
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: SupplierType) {
          return (
    ...
    <>
      ...
      <div className="page-master__table">
        <StandardTable
          ...
          locale={{
            emptyText: <SupplierTypeEmptySearchData />,
          }}
        />
