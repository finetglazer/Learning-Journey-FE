...
import { SupplierTypeMasterAdvanceFilter } from "./SupplierTypeAdvanceFilter";

export const SupplierTypeMasterAction = () => {
  const bank = useContext<SupplierTypeMasterContextModel>(
    SupplierTypeMasterContext
  );
  const {
    modelFilter,
  ...
  return (
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        <Dropdown
          dropdownRender={() => (
            <SupplierTypeMasterAdvanceFilter
              setVisible={() => {
                setVisible(false);
              }}
            />
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("supplierType.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
