...
import { NationMasterAdvanceFilter } from "./NationAdvanceFilter";

export const NationMasterAction = () => {
  const nation = useContext<NationMasterContextModel>(NationMasterContext);
  const {
    modelFilter,
    countFilter,
    dispatchFilter,
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("nations.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
