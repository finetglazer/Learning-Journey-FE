...
export const NationModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("nations.deleteTitle")
          : `${translate("nations.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("nations.bulkDeleteTitle2")}`
      }
      content={translate("nations.deleteContent")}
    />
  );
};
