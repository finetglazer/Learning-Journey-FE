...
export const CostTypeModalDelete = () => {
  const {
    isOpenModalDelete,
  ...
  return (
    <ModalConfirm
      ...
      title={
        deleteType === "Single"
          ? translate("costTypes.deleteTitle")
          : `${translate("costTypes.bulkDeleteTitle1")} ${
              selectedRowKeys?.length || 0
            } ${translate("costTypes.bulkDeleteTitle2")}`
      }
      content={translate("costTypes.deleteContent")}
    />
  );
};
