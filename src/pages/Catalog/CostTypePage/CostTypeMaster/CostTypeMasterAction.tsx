...
import { CostTypeMasterAdvanceFilter } from "./CostTypeAdvanceFilter";

export const CostTypeMasterAction = () => {
  const costType = useContext<CostTypeMasterContextModel>(
    CostTypeMasterContext
  );
  const {
    modelFilter,
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("costTypes.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        {validAction("CREATE") && (
