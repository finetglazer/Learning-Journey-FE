...
import "./CostTypeMaster.scss";

import {
  CostTypeMasterContext,
  CostTypeMasterContextModel,
} from "./CostTypeMasterHook";
import { CostTypeEmptySearchData } from "./CostTypeEmptySearchData";
...
export const CostTypeMasterTable = () => {
  ...
  const columns: ColumnProps<CostType>[] = useMemo(
    () => [
      {
        title: translate("costTypes.code"),
        key: "code",
        dataIndex: "code",
        sorter: true,
        width: 150,
        render(...params: [string, CostType, number]) {
          return (
            <LayoutCell>
              <div
                className="w-100"
      ...
      {
        title: translate("costTypes.name"),
        key: "name",
        dataIndex: "name",
        sorter: true,
        render(...params: [string, CostType, number]) {
      ...
      {
        title: translate("costTypes.status"),
        key: "isActive",
        dataIndex: "isActive",
        sorter: true,
        width: "200px",
      ...
      },
      {
        ...
        width: 40,
        align: "center",
        render(id: number, record: CostType) {
          return (
    ...
    <>
      ...
      <div className="page-master__table">
        <StandardTable
          ...
          locale={{
            emptyText: <CostTypeEmptySearchData />,
          }}
        />
