...
import GroupActionDetailTestWorkflow from "../BudgetAdjustCreate/Components/GroupAction/GroupActionDetailTestWorkflow";

const BudgetAdjustDetailTestWorkflow = () => {
...
export default BudgetAdjustDetailTestWorkflow;
