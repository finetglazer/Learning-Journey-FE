...
import "./BudgetAdjustCreate.scss";
import { BudgetAdjustContext, useBudgetAdjustHook } from "./BudgetAdjustHook";
import GeneralInformation from "./Components/GeneralInformation/GeneralInformation";
import GroupAction from "./Components/GroupAction/GroupAction";
import { useBudgetSignFormHook } from "pages/BudgetPage/BudgetCreate/BudgetSignFormHook";
  ...
  return (
    <>
      <BudgetAdjustContext.Provider value={contextValue as any}>
        <div
          className={classNames("page-content-create-adjust", "page-content")}
        >
          <PageHeader
            title={title}
      ...
      {contextValue.model?.id && (
        <SignProcessModal
          ...
          tempateType={SIGN_PROCESS_TYPE.BUDGET_ADJUSTMENT}
        />
      )}
    </>
  );
...
export default BudgetAdjustCreate;
