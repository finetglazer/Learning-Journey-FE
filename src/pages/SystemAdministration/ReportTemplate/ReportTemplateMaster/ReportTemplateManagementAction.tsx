...
import { ReportTemplateAdvanceFilter } from "pages/SystemAdministration/ReportTemplate/ReportTemplateMaster/ReportTemplateAdvanceFilter";

export const ReportTemplateManagementAction = () => {
  const reportTemplateMaster = useContext<ReportTemplateManagementContextProps>(
    ReportTemplateManagementContext
  );
  const {
    modelFilter,
    ...
    <>
      ...
      <div className="page-master__actions d-flex align-items-center mt-4 me-1">
        ...
        >
          <div onClick={() => setVisible(true)}>
            <Button
              ...
              className="m-r--xs"
            >
              {translate("currencies.advanceFilter")}
            </Button>
          </div>
        </Dropdown>
        ...
        <Button
          ...
          type="primary"
          size="lg"
          onClick={() => handleOpenModal(null, "detail")}
        >
