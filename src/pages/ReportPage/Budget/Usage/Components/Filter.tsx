...
import { DatePicker, FormItem, Select } from "react-components-design-system";
...
export default function Filter({
  ...
  const dateFormat: DatePickerProps["format"] = (value) =>
    `${translate("CM.txt_month")} ${value.format("M/YYYY")}`;
  ...
  return (
    <FilterReport {...filterReportProps}>
      <div className="form-item">
        <FormItem
          validateObject={utilService.getValidateObj(
            modelFilter?.businessUnitValue ? undefined : error,
            "businessUnitId"
          )}
        >
          <Select
      ...
      <div className="form-item">
        <FormItem
          validateObject={utilService.getValidateObj(error, "reportPeriod")}
        >
          <DatePicker
