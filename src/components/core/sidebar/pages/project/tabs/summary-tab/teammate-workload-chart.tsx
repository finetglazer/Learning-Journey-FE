...
import { TeammateWorkload } from '@/model/project-management';
import React from 'react';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, Cell } from 'recharts';

export interface TeammateWorkloadChartProps {
    data?: TeammateWorkload[];
};

const ROW_HEIGHT = 50;
const MAX_CONTAINER_HEIGHT = 300;

export function TeammateWorkloadChart({ data }: TeammateWorkloadChartProps) {
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 flex flex-col h-full">
            {/* Header */}
            <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-800">Teammate Workload</h3>
                <p className="text-sm text-gray-500">Monitor the capacity of your team</p>
            </div>
